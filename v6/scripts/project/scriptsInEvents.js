...
const scriptsInEvents = {
	...
	async Gamesheet_Event36_Act2(runtime, localVars)
	{
		runtime.globalVars.MynewStrng = eval(runtime.globalVars.strg)
	},

	async Gamesheet_Event44_Act1(runtime, localVars)
	{
	...
	async Gamesheet_Event59_Act3(runtime, localVars)
	{
	...
	async Gamesheet_Event80_Act1(runtime, localVars)
	{
		function iosCheck()
		{
	...
	async Gamesheet_Event82_Act1(runtime, localVars)
	{
		function iosCheck()
		{
			var ios = localStorage.getItem("ios");
