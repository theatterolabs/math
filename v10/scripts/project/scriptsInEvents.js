...
const scriptsInEvents = {
	...
	async Gamesheet_Event44_Act2(runtime, localVars)
	{
		runtime.globalVars.MynewStrng = eval(runtime.globalVars.strg)
	},

	async Gamesheet_Event52_Act1(runtime, localVars)
	{
	...
	async Gamesheet_Event67_Act3(runtime, localVars)
	{
	...
	async Gamesheet_Event88_Act1(runtime, localVars)
	{
		function iosCheck()
		{
	...
	async Gamesheet_Event90_Act1(runtime, localVars)
	{
		function iosCheck()
		{
			var ios = localStorage.getItem("ios");
